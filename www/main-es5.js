...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
    var map = {
      "./pages/inside/inside.module": ["./src/app/pages/inside/inside.module.ts", "pages-inside-inside-module"],
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_auth_guard_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-add-song-add-song-module */
        [__webpack_require__.e("common"), __webpack_require__.e("pages-add-song-add-song-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/add-song/add-song.module */
        "./src/app/pages/add-song/add-song.module.ts")).then(function (m) {
          return m.AddSongPageModule;
        });
      }
    }, {
      path: 'edit-song/:id',
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-edit-song-edit-song-module */
        [__webpack_require__.e("common"), __webpack_require__.e("pages-edit-song-edit-song-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/edit-song/edit-song.module */
        "./src/app/pages/edit-song/edit-song.module.ts")).then(function (m) {
    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function register(credentials) {
          ...
          return this.http.post("".concat(this.httpOptions, "/api/register"), credentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (e) {
            _this4.showAlert(e.error.msg);
        ...
        value: function login(credentials) {
          ...
          return this.http.post("".concat(this.httpOptions, "/api/login"), credentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (res) {
            _this5.storage.set(TOKEN_KEY, res['token']);

            _this5.user = _this5.helper.decodeToken(res['token']);
        ...
        value: function getSpecialData() {
          ...
          return this.http.get("".concat(this.httpOptions, "/api/special")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (e) {
            var status = e.status;

            if (status === 401) {
              _this7.showAlert('You are not authorized for this!');
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Rithu\ionictrial\devdacticAuth\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
