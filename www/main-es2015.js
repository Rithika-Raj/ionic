...
let AuthService = class AuthService {
    ...
    register(credentials) {
        return this.http.post(`${this.httpOptions}/api/register`, credentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(e => {
    ...
    getSpecialData() {
        return this.http.get(`${this.httpOptions}/api/special`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(e => {
            let status = e.status;
            if (status === 401) {
...
module.exports = __webpack_require__(/*! C:\Users\Rithu\ionictrial\devdacticAuth\src\main.ts */"./src/main.ts");
